...
public class DecimalSubtraction extends SimpleProblem {
     ...
     * @param places
     */
    public DecimalSubtraction(int max1, int max2, int places) {
        this.max1 = max1;
        this.max2 = max2;
        this.places = places;
    ...
    public Problem next() {
        return new DecimalSubtraction(max1, max2, places);
    }
}
