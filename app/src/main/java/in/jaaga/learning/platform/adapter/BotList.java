...
public class BotList extends RecyclerView.Adapter<BotList.ViewHolder> {
    ...
    public BotList(Context context, int layoutResourceId, ArrayList<HashMap<String, String>> bot_list, OnItemClickListener itemClickListener) {
